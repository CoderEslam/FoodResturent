package com.doubleclick.foodresturent.android.views.SimpleSearchView.utils
...
object EditTextReflectionUtils {
     ...
     */
    @JvmStatic
    fun setCursorEtDrawable(editText: EditText, drawable: Int) {
        try {
     ...
     */
    @JvmStatic
    fun setCursorEtColor(editText: EditText, @ColorInt color: Int) {
        try {
