package com.doubleclick.foodresturent.android.views.SimpleSearchView
...
import com.doubleclick.foodresturent.android.views.SimpleSearchView.utils.ContextUtils.scanForActivity
import com.doubleclick.foodresturent.android.views.SimpleSearchView.utils.ContextUtils.showKeyboard
import com.doubleclick.foodresturent.android.views.SimpleSearchView.utils.DimensUtils.convertDpToPx
import com.doubleclick.foodresturent.android.views.SimpleSearchView.utils.EditTextReflectionUtils.setCursorEtColor
import com.doubleclick.foodresturent.android.views.SimpleSearchView.utils.EditTextReflectionUtils.setCursorEtDrawable
import com.doubleclick.foodresturent.android.views.SimpleSearchView.utils.SimpleAnimationListener
import com.doubleclick.foodresturent.android.views.SimpleSearchView.utils.SimpleAnimationUtils
...
class SimpleSearchView @JvmOverloads constructor(
    ...
    private fun initStyle(attrs: AttributeSet?, defStyleAttr: Int) {
        val typedArray =
            context.obtainStyledAttributes(attrs, R.styleable.SimpleSearchView, defStyleAttr, 0)
    ...
    fun setCursorDrawable(@DrawableRes drawable: Int) = with(binding) {
        setCursorEtDrawable(searchEditText, drawable)
    }
    ...
    fun setCursorColor(@ColorInt color: Int) = with(binding) {
        setCursorEtColor(searchEditText, color)
    }
