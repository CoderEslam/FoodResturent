...
import com.doubleclick.foodresturent.android.views.EasingInterpolator.Ease
import com.doubleclick.foodresturent.android.views.EasingInterpolator.EasingInterpolator
...
class ShineView : View {
    ...
    constructor(context: Context?, shineButton: ShineButton, shineParams: ShineParams) : super(
        ...
        clickAnimator!!.setInterpolator(EasingInterpolator(Ease.QUART_OUT))
        clickAnimator!!.addUpdateListener(AnimatorUpdateListener { valueAnimator ->
    ...
    fun showAnimation(shineButton: ShineButton?) {
        ...
        if (shineButton.mFixDialog != null && shineButton.mFixDialog!!.window != null) {
            ...
            centerAnimX = centerAnimX - decor.paddingLeft
            centerAnimY = centerAnimY - decor.paddingTop
        }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in 0 until shineCount) {
            ...
            canvas.drawArc(
                rectF, 360f / shineCount * i + 1 + (value - 1) * turnAngle, 0.1f, false,
    ...
    companion object {
        ...
        private const val FRAME_REFRESH_DELAY: Long =
            25 //default 10ms ,change to 25ms for saving cpu.
